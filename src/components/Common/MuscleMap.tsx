            ...
            <div className="muscle-image-container" style={{ overflow: 'hidden', position: 'relative' }}>
              <img 
                ...
                style={{
                  ...
                  height: '100%',
                  objectFit: 'contain',
                  clipPath: 'inset(28% 0px 0px 0px)', // Recorta os 28% do topo onde fica o texto da imagem original
                  transform: 'scale(1.6) translateY(18px)', // Dá mais zoom e recentraliza o músculo para esconder o texto
                  filter: imageFilter,
